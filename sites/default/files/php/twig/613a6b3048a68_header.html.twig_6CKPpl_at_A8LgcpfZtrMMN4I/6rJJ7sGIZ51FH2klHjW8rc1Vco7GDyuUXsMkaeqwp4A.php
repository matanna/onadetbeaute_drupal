...
class __TwigTemplate_e24d6b89965794ad3438b3d4e24cf763ccf5d8e3fd20e30de6df5ee0532732dd extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  ";
        ...
        if ((($context["is_front"] ?? null) && ($context["slider_show"] ?? null))) {
            // line 40
            echo "    ";
            $this->loadTemplate((($context["directory"] ?? null) . "/templates/slider.html.twig"), "themes/custom/child_vani/templates/header.html.twig", 40)->display($context);
            // line 41
            echo "  ";
        } elseif ( !($context["is_front"] ?? null)) {
            // line 42
            echo "    ";
            $this->loadTemplate("@vani/template-parts/page_header.html.twig", "themes/custom/child_vani/templates/header.html.twig", 42)->display($context);
            // line 43
            echo "  ";
        }
        // line 44
...
";
  ...
  {% if is_front and slider_show %}
    {% include directory ~ '/templates/slider.html.twig' %}
  {% elseif not is_front %}
    {% include '@vani/template-parts/page_header.html.twig' %}
  {% endif %}
</header>
", "themes/custom/child_vani/templates/header.html.twig", "/var/www/html/onadetbeaute/themes/custom/child_vani/templates/header.html.twig");
    }
